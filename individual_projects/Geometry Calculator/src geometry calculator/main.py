...
from geofunction import Square, Rectangle, Circle, Triangle, input_check, int_input, compare, view, edit, create, specify
...
while True:
    ...
    if uinput == '1':
        ...
        compare(specify(library, 'first'), specify(library, 'second'))
    elif uinput == '3':
        view(library)
    elif uinput == '4':
        edit(library)
