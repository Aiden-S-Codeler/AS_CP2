...
from character_create import character_create, character_generate
...
def main_menu():
    ...
    while True:
        ...
        print("\nYou can: \n1. Create a Character \n2. Edit a Character \n3. View a Character \n4. Roll some dice\n5. Generate Random Character\n6. Exit the Program(This will wipe all data!)")
        ...
        match user_choice:
            ...
            case "3":
                ...
                charting = [str(character['stats']['strength']), str(character['stats']['dexterity']), str(character['stats']['resilience']), str(character['stats']['magic'])]
                category = ['strength', 'dexterity', 'resilience', 'magic']
            ...
            case "5":
                character_generate(character_index)
